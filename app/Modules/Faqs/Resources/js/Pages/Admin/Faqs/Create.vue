...
<template>
    <Head title="New faq" />
    <h1 class="mb-6 text-2xl font-bold text-gray-900">New faq</h1>
    ...
    <form class="max-w-2xl space-y-4" @submit.prevent="submit">
        ...
        <div>
            ...
            <p class="mt-1 text-xs text-gray-500">Leave as Global to show when a page has no assigned FAQs.</p>

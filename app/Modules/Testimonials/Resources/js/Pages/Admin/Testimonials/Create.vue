...
<template>
    ...
    <h1 class="text-2xl font-bold text-gray-900 mb-6">New testimonial</h1>
    ...
    <form class="max-w-2xl space-y-4" @submit.prevent="submit">
        ...
        <div class="flex gap-2">
            ...
            <Link :href="route('admin.testimonials.index')" class="rounded border border-gray-300 px-4 py-2 text-sm text-gray-700">Cancel</Link>
        </div>
    </form>
</template>

        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div class="aspect-square bg-gray-100 rounded-lg overflow-hidden">
                    <img v-if="product.featured_image" :src="product.featured_image" :alt="product.name" loading="eager" fetchpriority="high" decoding="async" class="w-full h-full object-cover" />
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
                <Link v-for="rp in relatedProducts" :key="rp.id" :href="`/shop/${rp.slug}`" class="group bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow overflow-hidden">
                    <div class="aspect-square bg-gray-100 overflow-hidden">
                        <img v-if="rp.featured_image" :src="rp.featured_image" :alt="rp.name" loading="lazy" decoding="async" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300" />
                        <div v-else class="w-full h-full flex items-center justify-center text-gray-400">

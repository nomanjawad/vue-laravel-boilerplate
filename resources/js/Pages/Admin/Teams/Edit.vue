...
const form = useForm({
    ...
    social_links: {
        facebook: props.member.social_links?.facebook || '',
        twitter: props.member.social_links?.twitter || '',
        linkedin: props.member.social_links?.linkedin || '',
    },
...
const submit = () => {
    form.put(`/admin/teams/${props.member.id}`)
}
</script>

 ...
 * the media library browser via a lightweight overlay trigger.
 */
    ...
    editorProps: {
        ...
        handleKeyDown: (_view, event) => {
            if (event.key === '/' && !event.metaKey && !event.ctrlKey) {
                // Open slash palette after the character is typed.
                setTimeout(() => {
...
<template>
    <div class="relative rounded-lg border border-gray-300 bg-white">
        ...
        >
            ...
            <span class="ml-auto text-[11px] text-gray-400">Type / for blocks</span>
        </div>

...
<x-mail::message-branded :subject="'New contact form submission — ' . $siteName">
    ...
    <table cellpadding="0" cellspacing="0" border="0" style="font-size:14px;">
        <tr><td style="color:#64748b;padding:4px 8px 4px 0;">From</td><td>{{ $senderName }} &lt;{{ $senderEmail }}&gt;</td></tr>
    ...
    <div style="margin-top:16px;padding:12px;background:#f8fafc;border-radius:6px;white-space:pre-wrap;">{{ $messageBody }}</div>
